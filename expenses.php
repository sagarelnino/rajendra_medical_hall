...
$next_page = $page_no + 1;
$adjacents = "2";
$total_records = $expense->getAllExpensesNumber();
$total_no_of_pages = ceil($total_records / $total_records_per_page);
$second_last = $total_no_of_pages - 1;
$allExpense = $expense->getAllExpensesWithLimit($offset,$total_records_per_page);
if(empty($allExpense)){
    $_SESSION['message'] = 'No expense in the list';
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <table class="table table-bordered">
            ...
            <?php foreach ($allExpense as $singleExpense){ ?>
                <tr>
                    ...
                    <td>
                        <?php
                            $adminDetails = $admin->getAdminById($singleExpense['issuedBy']);
                            echo $adminDetails['fullname'];
                        ?>
                    </td>
                    <td><?php echo $singleExpense['created'];?></td>

                    <td><a href="delete_expense.php?id=<?php echo $singleExpense['id'];?>" class="btn btn-danger">Delete</a> </td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
